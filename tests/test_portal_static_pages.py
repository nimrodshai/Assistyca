...
class PortalStaticPageTests(unittest.TestCase):
    ...
    def test_monitor_actions_support_manual_runs_and_manual_only_mode(self) -> None:
        ...
        # "Active" used to mean both "runs on its own" and "sits here until I
        # press Run", which are different things to a client. Two lists now.
        self.assertIn("function isAgentOnDemandAction", script)
        self.assertIn("Nothing runs on a schedule yet.", script)
        ...
        # Finished runs are not listed at all now: the panel holds the two live
        ...
        self.assertNotIn("agent-history", styles)
        self.assertIn(">Recurring<", html)
        self.assertIn(">On demand<", html)
        self.assertIn("overflow-anchor: none", styles)
        self.assertIn('id="agentPendingActionList"', html)
        self.assertIn('id="agentOnDemandActionList"', html)
        ...
        self.assertIn('"https://www.googleapis.com/auth/calendar.events"', script)
        self.assertIn("https://www.googleapis.com/auth/gmail.send", script)
        self.assertIn("Read Gmail messages, and send an email or a reply when you ask.", script)
        self.assertIn("Read Google Drive files when an action runs.", script)
        self.assertIn('accessLabel: "Read & send"', script)
        ...
        self.assertIn("grid-template-columns: minmax(5.5rem, auto) minmax(13.5rem, 1fr);", styles)
        self.assertIn(".calendar-oauth-button-label", styles)
