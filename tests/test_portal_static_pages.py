...
class PortalStaticPageTests(unittest.TestCase):
    ...
    def test_monitor_actions_support_manual_runs_and_manual_only_mode(self) -> None:
        ...
        self.assertIn("editorFieldOptions.select = true;", script)
        self.assertIn("getAgentCalendarSummaryDateRangeOptions(draft[key])", script)
        self.assertIn('control.input.addEventListener(editorFieldOptions.select ? "change" : "input"', script)
