...
class PortalStaticPageTests(unittest.TestCase):
    ...
    def test_about_contact_modal_includes_mobile_keyboard_layout_hooks(self) -> None:
        ...
        self.assertIn("grid-template-rows: minmax(0, 1fr) 0 0", body)
        ...
        self.assertIn("calc(0.82rem + var(--contact-keyboard-offset) + var(--contact-mobile-status-height) + var(--contact-mobile-composer-height))", body)
