...
class PortalStaticPageTests(unittest.TestCase):
    ...
    def test_agent_proposal_changes_use_contextual_structured_revision(self) -> None:
        ...
        self.assertIn('apiRequest("/api/agent/turn"', script)
        self.assertIn("styles.css?v=129", html)
        ...
        self.assertIn('actions.push(createAgentAction(', script)
        self.assertIn('"Monthly",', script)
        self.assertIn("monthly, at the beginning of the next month", script)
        self.assertIn("isAgentRunModeQuestionText(questionText)", script)
        self.assertIn("getAgentQuestionActions(proposal, actionIndex, messageText)", script)
