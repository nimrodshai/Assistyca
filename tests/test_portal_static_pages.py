...
class PortalStaticPageTests(unittest.TestCase):
    ...
    def test_agent_proposal_changes_use_contextual_structured_revision(self) -> None:
        ...
        self.assertIn('apiRequest("/api/agent/turn"', script)
        self.assertIn("styles.css?v=130", html)
        ...
        self.assertIn("function getAgentMonthlyBatchQuestionText", script)
        self.assertIn("Should I pull ${oneTimeTarget} once", script)
        self.assertIn("set this up so each month pulls the previous month's ${objectLabel}", script)
        ...
        self.assertIn("getAgentQuestionActions(proposal, actionIndex, displayText)", script)
        ...
        self.assertIn("getAgentQuestionActions(proposal, questionIndex, questionText)", script)
