...
AGENT_LOOP_INSTRUCTIONS = (
    ...
    "shaped by what is connected, and cover every kind of thing they have: the diary, the mail, the receipts "
    "and what they add up to, reminders, and their lists. The lists are a page of their own that the person "
    "may not know they have, so name them every time, and put CONTEXT.listsPage on its own line so they "
    "can open it.\n"
...
_CHANNEL_RULES = {
    "whatsapp": (
        ...
        "right now, in their own voice, shaped by what is connected, and invent fresh ones each time; spread "
