...
_FAMILY_GETTING_TO_KNOW = (
    ...
    "pass on. Anything they have already told you earlier in the conversation is answered: save it with "
    "save_family_member and carry on from there, rather than putting the same question to them a second "
    "time. Call set_getting_to_know with in_progress when you ask the first question, and again when "
